...
// Require axios and cheerio, making scrapes possible
...
var scrape = function () {
    ...
    return axios.get("http://www.nytimes.com").then(function (res) {
        ...
        $(".assetWrapper").each(function (i, element) {
            // In each article section, grab the headline, URL, and summary
            ...
            // So long as the headline and sum and url aren't empty or undefined, do the following
            if (head && sum && url) {
